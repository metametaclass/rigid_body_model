...
#define NPY_INLINE
  ...
  {
    return (!quaternion_isnan(q1) && !quaternion_isnan(q2)) &&
           (q1.w != q2.w ? q1.w < q2.w : q1.x != q2.x ? q1.x < q2.x
                                     : q1.y != q2.y   ? q1.y < q2.y
                                     : q1.z != q2.z   ? q1.z < q2.z
                                                      : 0);
  }
  ...
  //http://www.cs.cmu.edu/~barbic/code/quaternion/
  ...
  static NPY_INLINE void quaternion_to_rotation_matrix(quaternion q, double R[])
  {
    R[0] = 1 - 2 * q.y * q.y - 2 * q.z * q.z;
    R[1] = 2 * q.x * q.y - 2 * q.w * q.z;
    R[2] = 2 * q.x * q.z + 2 * q.w * q.y;
    R[3] = 2 * q.x * q.y + 2 * q.w * q.z;
    R[4] = 1 - 2 * q.x * q.x - 2 * q.z * q.z;
    R[5] = 2 * q.y * q.z - 2 * q.w * q.x;
    R[6] = 2 * q.x * q.z - 2 * q.w * q.y;
    R[7] = 2 * q.y * q.z + 2 * q.w * q.x;
    R[8] = 1 - 2 * q.x * q.x - 2 * q.y * q.y;
  }
